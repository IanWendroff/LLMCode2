...
bool send_line(int sock, const std::string& line){
    return send(sock, line.c_str(), line.size(), 0) > 0;
}
...
void load_config(){
    nodes[0] = {"128.180.120.77", 4040}; //io: 128.180.120.77, neptune: 128.180.120.95
    nodes[1] = {"128.180.120.73", 4040}; //eris: 128.180.120.73
    nodes[2] = {"128.180.120.87", 4040}; //saturn 
    nodes[3] = {"128.180.120.67", 4040}; // callisto: 128.180.120.67 
